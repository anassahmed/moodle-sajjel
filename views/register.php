...
<div class="container">
    <div class="row">
        <div class="alert alert-success" role="alert">
            ...
            <?php echo "You have successfully registered in that course"; ?>
        </div>
    </div>
    <div class="row">
        <div class="text-center">
            <h1>Thank you!</h1>
            <h2>We hope you enjoy learning with us!</h2>
        </div>
    </div>
</div>
<?php
...
<div class="container">
    <div class="row">
        ...
        <div class="col-xs-12 col-md-6 center-block">
            <h1>Register in our E-Learning System</h1>
            <form method="POST">
                <input type="hidden" id="register_student" name="register_student"
                    value="1"/>
                ...
                <button type="sumbit" class="btn btn-primary pull-right">Register</button>
            </form>
        </div>
    </div>
</div>
